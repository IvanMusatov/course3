from functions import sorted_state_executed, load_data, format_date, format_check, format_card, manipulation


def test_sorted_state_executed():
    list_ = [
        {
            "id": 441945886,
            "state": "EXECUTED",
    ...
    sorted_list = [{'id': 863064926, 'state': 'EXECUTED', 'date': '2019-12-08T22:46:21.935582',
    ...
    assert sorted_state_executed(list_) == sorted_list
...
def test_format_check():
    list_ = "Счет 64686473678894779589"
    assert format_check(list_) == 'Счет **9589'


def test_format_card():
    list_ = "Maestro 1596837868705199"
    assert format_card(list_) == 'Maestro 1596 83** **** 5199'
...
def test_manipulation():
    ...
    assert manipulation(data) == f'''08.12.2019 Открытие вклада
Счет **5907
41096.24 USD
